...
if($_POST['act']=='add'){ //如果是按下新增的按鈕
    ...
    $array_sort = array("Business", "Science", "ComSci", "Med", "Language", "Social Science", "Humanities", "Art and Design", "Travel", "Textbook", "Test Materials", "Novels", "Comics", "Picture Books", "Children's Book");
