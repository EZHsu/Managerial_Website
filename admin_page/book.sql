...
(1, '9789869968737', '從此好好過生活', '張琉珍', '王品涵', NULL, '新經典文化', '2021/02/03', 'Novel', '1.jpg', '2022-05-17', '2022-05-10', '1', '11'),
(2, '9789573289982', '老派少女購物路線', '洪愛珠', NULL, NULL, '遠流', '2021 / 03 / 26', 'Travel', '2.jpg', '2022-05-09', '2022-05-05', '1', '11'),
(3, '9571039640985', '暮光之城', '史蒂芬妮．梅爾', '瞿秀蕙', '', '尖端出版', '2001 / 04 / 23', 'Novel', 'feature-1.jpg', '0000-00-00', '2022-05-17', '1', ''),
(4, '978014313015', 'Me Before You', 'Moyes, Jojo', '', '', 'Penguin Group U', '2005 / 03 / 18', 'Novel', 'feature-3.jpg', '0000-00-00', '2022-05-17', '1', ''),
(5, '9789860629392', '30年青春‧震耳欲聾', '許理平(虎哥)', '', '', '出色文化', '2008 / 08 / 06', 'Art and Design', 'feature-2.jpg', '0000-00-00', '2022-05-17', '1', ''),
(6, '9789576587405', '大概是時間在煮我吧', '張西', '', '', '三采文化股份有限公司', '2011 / 05 / 28', 'Textbook', 'feature-4.jpg', '0000-00-00', '2022-05-17', '1', ''),
(7, '9781984814692', 'How It Feels to Float', 'Helena Fox', '', '', 'Penguin Group (', '2001 / 06 / 10', 'Novel', 'feature-5.jpg', '0000-00-00', '2022-05-17', '1', ''),
(8, '9789571386508', '此生，你我皆短暫燦爛', '王鷗行', ' 何穎怡', NULL, '時報出版', '2021 / 03 / 05', 'Novel', '5.jpg', NULL, '0000-00-00', '1', ''),
(9, '9789573266815', '一個都不留', '克里絲蒂', '劉萬男', '', '遠流', '2010 / 08 / 01', 'Novel', '一個都不留.jpg', '0000-00-00', '2022-05-19', '1', 'joanna'),
(10, '9786267061190', '我們想去的地方', '張琉珍', '胡椒筒', '', '新經典文化', '2022 / 04 / 27', 'Humanities', '3.jpg', '0000-00-00', '2022-05-19', '1', '11'),
(20, '9789574449644', '傷心咖啡店之歌', '朱少麟', '', '', '九歌', '2014/10/30', 'Novel', '傷心咖啡店之歌.jpg', '0000-00-00', '2022-05-20', '0', 'joanna');
