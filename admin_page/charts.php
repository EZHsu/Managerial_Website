        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Reports</h1><br>
<!--
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Monthly Counts 2022</h6>
                                </div>
                                <div class="card-body">
...
-->
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Monthly Rank</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
...
-->
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Categories Past Month</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
...
-->
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Book Amount by Categories</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
